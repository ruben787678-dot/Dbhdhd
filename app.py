...
}# Данные для блока "Խմբագրեր" на главной странице
INTRO_DATA = {
    'compilers': ['Վահե Շահնազարյան', 'Թաթևոսյան Ռուբեն', 'Անուն Ազգանուն 3'],
    'assignments': [
        ('Հայոց լեզու', 'Վահե Շահմազարյան'),
        ('Հայ գրականություն', 'Վահե Շահնազարյան'),
        ('Հայոց պատմություն', 'Վահե Շահնազարյան'),
        ('Համաշխարհային պատմություն', 'Վահե Շահնազարյան'),
        ('Ռուսաց լեզու', 'Վահե Շահնազարյան'),
        ('Անգլերեն', 'Վահե Շահնազարյան')
    ],
